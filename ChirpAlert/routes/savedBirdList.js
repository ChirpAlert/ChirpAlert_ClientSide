						...
						<View>
							<View>
								<Image style={styles.birdPic}
									source={{uri:rowData.bird.imageUrl}}/>
							</View>
							<View style={styles.birdInfo}>
				        <View>
				          <Text style={styles.header}>{rowData.bird.englishName}</Text>
								</View>
								<View>
				          <Text style={styles.subHeader}>Location: {rowData.bird.loc}</Text>
								</View>
								<View>
									<Text style={styles.subHeader}>Date: {rowData.bird.date}</Text>
								</View>
								<View>
									<Text style={styles.subHeader}>Time: {rowData.bird.time}</Text>
								</View>
							</View>
						</View>
		      </TouchableHighlight>
